#!/bin/sh
# Tom's Auto Rice Boostrapping Script (LARBS)
...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/tzurita/archrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/tzurita/TARBS/master/progs.csv"
