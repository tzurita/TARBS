...
# by Tom Zurita <tzurita@gmail.com>
# License: GNU GPLv3
...
welcomemsg() {
	whiptail --title "Welcome!" \
		--msgbox "Welcome to Tom's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my main machine.\\n\\n-Tom" 10 60
...
usercheck() {
	! { id -u "$name" >/dev/null 2>&1; } ||
		whiptail --title "WARNING" --yes-button "CONTINUE" \
			--no-button "No wait..." \
			--yesno "The user \`$name\` already exists on this system. TARBS can install for a user already existing, but it will OVERWRITE any conflicting settings/dotfiles on the user account.\\n\\nTARBS will NOT overwrite your user files, documents, videos, etc., so don't worry about that, but only click <CONTINUE> if you don't mind your settings being overwritten.\\n\\nNote also that TARBS will change $name's password to the one you just gave." 14 70
}
...
maininstall() {
	...
	whiptail --title "TARBS Installation" --infobox "Installing \`$1\` ($n of $total). $1 $2" 9 70
	installpkg "$1"
}
...
makeuserjs(){
	...
	userjs="$pdir/user.js"
	ln -fs "/home/$name/.config/firefox/tarbs.js" "$overrides"
...
Defaults:%wheel,root runcwd=*" >/etc/sudoers.d/tarbs-temp
...
# Cleanup
rm -f /etc/sudoers.d/tarbs-temp

# Tom Z Mods
# Install oh-my-zsh
git clone "https://github.com/ohmyzsh/ohmyzsh.git" "/home/$name/.config/oh-my-zsh"
git clone "https://github.com/romkatv/powerlevel10k.git" "/home/$name/.config/oh-my-zsh/custom/themes/powerlevel10k"
git clone "https://github.com/zsh-users/zsh-syntax-highlighting.git" "/home/$name/.config/oh-my-zsh/custom/plugins/zsh-syntax-highlighting"
git clone "https://github.com/zsh-users/zsh-autosuggestions" "/home/$name/.config/oh-my-zsh/custom/plugins/zsh-autosuggestions"
git clone "https://github.com/Aloxaf/fzf-tab" "/home/$name/.config/oh-my-zsh/custom/plugins/fzf-tab"
chown -R "$name":wheel /home/"$name/.config/oh-my-zsh"

# Install doom-vim
git clone "https://github.com/NTBBloodbath/doom-nvim" "/home/$name/.config/nvim"
chown -R "$name":wheel /home/"$name/.config/nvim"

# Install Create necessary dirs
for i in  dl dox pix repos vids
do
    mkdir /home/"$name"/"$i"
    chown -R "$name":wheel /home/"$name/$i"
done

# Install doom-emacs
git clone --depth=1 "https://github.com/hlissner/doom-emacs" "/home/$name/.config/emacs"
chown -R "$name":wheel /home/"$name/.config/emacs"
