...
* Author: Tom Zurita <tzurita@gmail.com>
...
4. Copy the `arch-install.sh` script to the live system.

With ssh, start the ssh daemon first:

systemctl start sshd.service

5. Make the `arch-install.sh` script executable.
...
Heavily based on the work of tom5760/arch-install
