# Tom's Auto-Rice Bootstrapping Scripts (TARBS)
...
```
curl -LO https://raw.githubusercontent.com/tzurita/TARBS/master/static/tarbs.sh
sh tarbs.sh
```
...
By default, TARBS uses the programs [here in progs.csv](static/progs.csv) and installs
[my dotfiles repo (dotfiles) here](https://github.com/tzurita/dotfiles),
